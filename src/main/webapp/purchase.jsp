...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <!-- Nội dung trang web -->
        <h2 class="title m-auto mt-2 mb-5" >Mua vé</h2>
        <div class="container">
            <form action="" class="col-sm-auto justify-content-sm-center">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label" for="customRadio3">Máy bay</label>
                    </div>
                </div>
                <div class="form-group">
                    <label for=""><strong>Ngày đi</strong></label>
                ...
                <div class="form-group">
                    <label for=""><strong>Số lượng vé</strong></label>
                    <input type="number" class="form-control" id="soluongve" placeholder="">
                </div>
                <div class="form-group">
                    <label for=""><strong>Giá vé (VNĐ)</strong></label>
                    <input type="text" class="form-control" id="giave" placeholder="">
                </div>
                <button type="submit" class="btn btn-primary float-right">Quay lại</button>
                <button type="submit" class="btn btn-danger float-right  mr-1">In vé</button>
            </form>
        </div>
